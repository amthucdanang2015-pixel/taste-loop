...
export function CtaBlock({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-line bg-gradient-to-br from-accent/12 to-accent2/10 p-5">
      ...
      <Link href={href} data-analytics-location="about-final" className="shrink-0 rounded-full bg-white px-4 py-2 text-sm font-medium text-ink transition hover:bg-white/90">
        {cta}
      </Link>
    </div>
  );
